...
// ======= Times (ms) ==========
// some times reduced for testing
...
// ======== MQTT ==========
const char* MQTT_HOST = "f1bd5a3c43044a3a816321410ca2043.s1.eu.hivemq.cloud";
const int   MQTT_PORT = 8883;
const char* MQTT_USER = "P4P-Buoy";  
const char* MQTT_PASS = "P4P108-buoy"; 

static const char CA_CERT[] PROGMEM = R"EOF(
-----BEGIN CERTIFICATE-----

...
B5iPNgiV5+I3lg02dZ77DnKxHZu8A/lJBdiB3QW0KtZB6awBdpUKD9jf1b0SHzU
...

